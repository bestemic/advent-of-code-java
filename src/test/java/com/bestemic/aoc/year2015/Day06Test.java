...
class Day06Test {
    ...
    void testPart1() throws IOException {
        List<String> input = InputReader.readTestLines(YEAR_2015, DAY_06 + PART_1);
    ...
    void testPart2() throws IOException {
        List<String> input = InputReader.readTestLines(YEAR_2015, DAY_06 + PART_2);
        String result = solution.part2(input);

        assertEquals("2000001", result);
    }
}
